...
```bash
git remote add encore encore://academic-writing-assistant-5k62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/academic-writing-assistant-5k62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/academic-writing-assistant-5k62/settings/integrations/github)
